    ...
    public partial class CursoAngularNetCoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer(configurationRoot.GetConnectionString("DatabaseSQL"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LineasPedido>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPedidoNavigation)
                    ...
                    .HasConstraintName("FK_LINEAS_PEDIDO_PEDIDOS");

                entity.HasOne(d => d.IdProductoNavigation)
                    .WithMany(p => p.LineasPedidos)
                    .HasForeignKey(d => d.IdProducto)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_LINEAS_PEDIDO_PRODUCTOS");
            });
